...
with open('/media/roderickmajoor/TREKSTOR/Train/images/annotations.json', 'r') as f:
...
with open('/media/roderickmajoor/TREKSTOR/Train/images/annotations_updated.json', 'w') as f:
